...
while(True):
        ...
        for handLms in results.multi_hand_landmarks:
            for id, lm in enumerate(handLms.landmark):
                ...
                if id == 8:
                    ...
                    elif cx in range(300,350) and cy in range(370,413):
                        current_key = 'down'
                        pyautogui.keyDown(current_key)
    ...
    ta2_start_point = l2_start_point
    ta2_end_point = ((l2_start_point[0]+l2_end_point[0])//2,l2_start_point[1]+43)
    tb2_start_point = l2_end_point
    tb2_end_point = ta2_end_point
